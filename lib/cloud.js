...
exports.connect = function (config) {
  ...
  config.service = config.service || defaultConfig.service;
 ...
 */
exports.register = function (name, options, callback) {
  debug('register ' + name);
 ...
 * @param {function} callback
 */
exports.unregister = function (name, callback) {
 ...
 * @param {object} options
 */
exports.require = function (name, options) {
  debug('require ' + name);
  options = utils.merge(defaultConfig.service, options);
