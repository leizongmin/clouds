 ...
 *   - {String} id
 *   - {Object} redis {host, port, db, prefix, auth_pass}
 */
function Connection (options) {
  ...
  this._redisConnections.subscribe = utils.createRedisConnection(ns('redis.host'), ns('redis.port'), ns('redis.db'), ns('redis.auth_pass'));
  this._redisConnections.publish = utils.createRedisConnection(ns('redis.host'), ns('redis.port'), ns('redis.db'), ns('redis.auth_pass'));
