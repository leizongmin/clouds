...
CloudsClient.prototype._findOneServer = function (name, callback) {
  this._debug('find one server: %s', name);
  this._getHandler('find_one_server').call(this, name, callback);
};

CloudsClient.prototype._handleFindOneServer = function (name, callback) {
  var me = this;
