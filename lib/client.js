...
class CloudsClient extends EventEmitter {
   ...
   *   - {Number} timeout (s)
   *   - {Number} timeoutChecker  default: 1.1 (if the value less than 1 disable local checker)
   *   - {Number} heartbeat (s)
   */
  constructor(options) {
    super();
    ...
    this._timeoutChecker = ('timeoutChecker' in options) ? options.timeoutChecker : 1.1;
